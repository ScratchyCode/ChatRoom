    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                if(not nickname):
                    client.close
                    print(f"* Client '%s' disconnected." %address[0])
                    continue
            except:
                client.close
                print(f"* Disconnection client '%s': username handshake problem." %address[0])
                continue
            ...
            try:
                ...
                client.close
                print(f"* Disconnection client '%s': passwd handshake problem." %address[0])
                continue
